...
function Chatbot_v2() {
    ...
    const questions_Upper_Extremity = [
        ...
        { key: "Q14", question: (
            <>
                ...
                <img src={upper_extremity_photo_1} alt="UE Photo 1" style={{ width: '260px', height: '200px', borderRadius: '10px' }} />
            </>
        ), validator: (x) => x.toLowerCase() === 'yes' || x.toLowerCase() === 'no' },
        ...
        { key: "Q19", question: (
            <>
                ...
                <img src={upper_extremity_photo_2} alt="UE Photo 2" style={{ width: '260px', height: '200px', borderRadius: '10px' }} />
            </>
        ), validator: (x) => x.toLowerCase() === 'yes' || x.toLowerCase() === 'no' },
        ...
        { key: "Q31", question: (
            <>
                ...
                <img src={upper_extremity_photo_4} alt="UE Photo 4" style={{ width: '260px', height: '200px', borderRadius: '10px' }} />
            </>
        ), validator: (x) => x.toLowerCase() === 'yes' || x.toLowerCase() === 'no' },
        { key: "Q32", question: (
            <>
        ...
        { key: "Q55", question: (
            <>
                ...
                <img src={upper_extremity_photo_7} alt="UE Photo 7" style={{ width: '260px', height: '200px', borderRadius: '10px' }} />
            </>
        ), validator: (x) => x.toLowerCase() === 'yes' || x.toLowerCase() === 'no' },
        ...
        { key: "Q58", question: (
            <>
                ...
                <img src={upper_extremity_photo_8} alt="UE Photo 8" style={{ width: '260px', height: '200px', borderRadius: '10px' }} />
            </>
        ), validator: (x) => x.toLowerCase() === 'yes' || x.toLowerCase() === 'no' },
        ...
        { key: "Q63", question: (
            <>
                ...
                <img src={upper_extremity_photo_9} alt="UE Photo 9" style={{ width: '260px', height: '200px', borderRadius: '10px' }} />
            </>
        ), validator: (x) => x.toLowerCase() === 'yes' || x.toLowerCase() === 'no' },
        ...
        { key: "Q65", question: (
            <>
                ...
                <img src={upper_extremity_photo_10} alt="UE Photo 10" style={{ width: '260px', height: '200px', borderRadius: '10px' }} />
            </>
        ), validator: (x) => x.toLowerCase() === 'yes' || x.toLowerCase() === 'no' },
        ...
        { key: "Q67", question: (
            <>
                ...
                <img src={upper_extremity_photo_11} alt="UE Photo 11" style={{ width: '260px', height: '200px', borderRadius: '10px' }} />
            </>
        ), validator: (x) => x.toLowerCase() === 'yes' || x.toLowerCase() === 'no' },
        ...
        { key: "Q72", question: (
            <>
                ...
                <img src={upper_extremity_photo_12} alt="UE Photo 12" style={{ width: '260px', height: '200px', borderRadius: '10px' }} />
            </>
        ), validator: (x) => x.toLowerCase() === 'yes' || x.toLowerCase() === 'no' },
        ...
        { key: "Q74", question: (
            <>
                ...
                <img src={upper_extremity_photo_13} alt="UE Photo 13" style={{ width: '260px', height: '200px', borderRadius: '10px' }} />
            </>
        ), validator: (x) => x.toLowerCase() === 'yes' || x.toLowerCase() === 'no' },
    ...
    const questions_Low_Back_Pain = [
        ...
        { key: "Q35", question: (
            <>
                ...
                <img src={low_back_pain_photo_1} alt="LBP Photo 1" style={{ width: '260px', height: '200px', borderRadius: '10px' }} />
            </>
        ), validator: (x) => x.toLowerCase() === 'yes' || x.toLowerCase() === 'no' },
        { key: "Q36", question: (
            <>
    ...
    const disabilities_descriptions=[
        ...
        {key: "UpperExtremity", question: (
            <>
                ...
                <img src={cue_t_photo_1} alt="CT Photo 1" style={{ width: '260px', height: '200px', borderRadius: '10px' }} /><br />
                ...
                <img src={cue_t_photo_2} alt="CT Photo 2" style={{ width: '260px', height: '200px', borderRadius: '10px' }} /><br />
                ...
                <img src={cue_t_photo_3} alt="CT Photo 3" style={{ width: '260px', height: '200px', borderRadius: '10px' }} /><br />
            </>
        )},
        {key: "Movement", question: (
            <>
    ...
    const herokulink =""; // https://reconect-92e83e03af22.herokuapp.com/
    const sendMessage = async () => {
        try {
            ...
            if (currentStep === 'userInput') {
                try {
                    ...
                    if (classifiedPain.toLowerCase().includes(',')) {
                        ...
                        setMessages([...messages, { text: "Type 'lower extremity pain' and Send button to proceed. ", user: false }]);
                    } else if (classifiedPain.toLowerCase().includes('upper extremity pain')) {
                        setCurrentStep('userInput_Upper_Extremity');
                        setMessages([...messages, { text: "Type 'upper extremity pain' and Send button to proceed. ", user: false }]);
                    } else if (classifiedPain.toLowerCase().includes('back pain')) {
                        setCurrentStep('userInput_Low_Back_Pain');
                        setMessages([...messages, { text: "Type 'low back pain' and Send button to proceed. ", user: false }]);
                    } else if (classifiedPain.toLowerCase().includes('neck pain')) {
                        setCurrentStep('userInput_Neck_Pain');
                        setMessages([...messages, { text: "Type 'neck pain' and Send button to proceed. ", user: false }]);
                    } else {
            ...
            if (currentStep === 'File_not_exists') {
                const patient_info_temp = [];
                const temp_1 = prompt(`Enter Diagnosis (Possible choices: Traumatic Brain Injury, Stroke, Parkinsons Disease, Spinal Cord Injury, ALS, Peripheral Neuropathy.): `);
                patient_info_temp.push(temp_1);
                const temp_2 = prompt(`Enter disability (Tell me what’s bothering you the most among Cognition, UpperExtremity, or Movement. You can select multiple options): `);
                patient_info_temp.push(temp_2);
