...
def get_rehabilitation_evaluation(decreased_items, patient_info):
    ...
    system_prompt = """You are a renowned rehabilitation medicine specialist. Evaluate physical functions related to patient's disabilities and give feedbacks.
        ...
        - Provide only rehabilitation exercises that can be done at home without the help of medical professionals.
...
def suspected_complications(patient_info, diagnosis):
    ...
    system_prompt1 = """Please provide further evaluations and treatments of {suspected_comlication} with {context}.

    Further evaluations are tests to confirm the diagnosis of {suspected_comlication} itself.
    Treatments are direct treatments, not treatments for factors of {suspected_comlication}.
    ...
    **Treatments:**
    ...
    ## Response Format
    ⚑ Possible complication : {suspected_comlication}
    ...
    for complication, probability in top_3_diseases:
        ...
        response = rag_chain1.invoke({
            ...
            "suspected_comlication": complication,
        })
